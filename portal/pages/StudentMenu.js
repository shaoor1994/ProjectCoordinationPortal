...
export default class StudentMenu extends React.Component {
    render() {
      ...
      source={require('../images/reg.jpg')}>
           ...
           <TouchableOpacity onPress={()=>this.props.navigation.navigate("PickSupervisor")}>
             <View style={{height:100,width:340,borderRadius:30, alignContent:'center', backgroundColor:'#8B0000',justifyContent:'center'}}>
               <Text style={{textAlign:'center',  color:"white",fontSize:25}}>Select Supervisor</Text>
             </View>
           ...
           <TouchableOpacity onPress={()=>this.props.navigation.navigate("Login")}>
             ...
             <Text style={{textAlign:"center",color:"white",fontSize:25}}>Task Upload</Text>
             </View>
           </TouchableOpacity>
            </View>
             ...
             <TouchableOpacity onPress={()=>this.props.navigation.navigate("Login")}>
               <View style={{height:100,width:340,borderRadius:30,justifyContent:'center' ,alignContent:'center', backgroundColor:'#000080'}}>
                 <Text style={{textAlign:"center",color:"white",fontSize:25}}>Notification</Text>
               </View>
             </TouchableOpacity>
           </View>  
           <View style={{flex:1,alignItems:'center',marginTop:10}}>
             <TouchableOpacity onPress={()=>this.props.navigation.navigate("Login")}>
               <View style={{height:100,width:340,borderRadius:30, justifyContent:'center',alignContent:'center', backgroundColor:'#464643'}}>
                 <Text style={{textAlign:"center",color:"white",fontSize:25}}>Result</Text>
               </View>
             </TouchableOpacity>
           </View>  
